...
public class AjusteGrafico : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector3 bottomLeft = mainCamera.ViewportToWorldPoint(Vector3.zero) *2;
        Vector3 topRight = mainCamera.ViewportToWorldPoint(new Vector3(mainCamera.rect.width, mainCamera.rect.height)) *2;
